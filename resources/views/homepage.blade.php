...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* New styling for the single lecturer card to center it */
        .cards.lecturer {
            flex-wrap: wrap;
        }
...
<body>
    ...
    <section class="about-content">
     ...
     <div class="subtitle" data-aos="fade-up" data-aos-delay="400">
            ...
            <p style="max-width: 800px; margin: 0 auto; margin-top: 20px; font-size: 1.1em; line-height: 1.6; color: var(--dark-gray);">The experts guide us in creating the best solutions by providing strategic direction for the development of LEO Satellite Orbit Software</p>
        </div>
        <div class="container">
            <div class="main-card">
                <div class="cards lecturer">
                    <div class="card" data-aos="fade-up" data-aos-delay="500">
                        <div class="content">
                            <div class="img">
                                <img src="<?php echo asset('images/PakDhoni.jpg'); ?>" alt="Dhoni Putra Setiawan">
                            </div>
                            <div class="details">
                                <div class="name">Dhoni Putra Setiawan, S.T., M.T., Ph.D.</div>
                                <div class="jobdesk">First Academic Supervisor</div>
                            </div>
                            <div class="media-icons">
                                <a href="mailto:dosen@email.com" target="_blank" aria-label="Email Dosen"><i class="fas fa-envelope"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card" data-aos="fade-up" data-aos-delay="600">
                        <div class="content">
                            <div class="img">
                                <img src="<?php echo asset('images/PakEdwar.jpg'); ?>" alt="Edwar">
                            </div>
                            <div class="details">
                                <div class="name">Edwar, S.T., M.T.</div>
                                <div class="jobdesk">Second Academic Supervisor</div>
                            </div>
                            <div class="media-icons">
                                <a href="mailto:dosen2@email.com" target="_blank" aria-label="Email Dosen Kedua"><i class="fas fa-envelope"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
